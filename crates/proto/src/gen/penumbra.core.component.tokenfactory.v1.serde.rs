impl serde::Serialize for ActionTokenFactoryCreate {
        ...
        S: serde::Serializer,
    {
        ...
        let len = 0;
        let struct_ser = serializer.serialize_struct("penumbra.core.component.tokenfactory.v1.ActionTokenFactoryCreate", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for ActionTokenFactoryCreate {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.core.component.tokenfactory.v1.ActionTokenFactoryCreate")
            }
        ...
        deserializer.deserialize_struct("penumbra.core.component.tokenfactory.v1.ActionTokenFactoryCreate", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GenesisContent {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.core.component.tokenfactory.v1.GenesisContent", len)?;
...
impl<'de> serde::Deserialize<'de> for GenesisContent {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.core.component.tokenfactory.v1.GenesisContent")
            }
        ...
        deserializer.deserialize_struct("penumbra.core.component.tokenfactory.v1.GenesisContent", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for TokenFactoryParameters {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("penumbra.core.component.tokenfactory.v1.TokenFactoryParameters", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for TokenFactoryParameters {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.core.component.tokenfactory.v1.TokenFactoryParameters")
            }
        ...
        deserializer.deserialize_struct("penumbra.core.component.tokenfactory.v1.TokenFactoryParameters", FIELDS, GeneratedVisitor)
    }
}
